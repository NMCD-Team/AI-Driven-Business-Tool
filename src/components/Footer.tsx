    ...
    <div className="relative bg-[#000000] text-white py-20 px-6">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            <FaEnvelope className="text-white text-3xl mb-4 mx-auto" />
          ...
          <motion.div
            ...
            className="bg-[#6D828F] hover:bg-[#9AA7B2] transition-colors duration-300 p-6 rounded-xl text-center shadow-lg"
          >
            <FaPhone className="text-white text-3xl mb-4 mx-auto" />
          ...
          <motion.div
            ...
            className="bg-[#6D828F] hover:bg-[#9AA7B2] transition-colors duration-300 p-6 rounded-xl text-center shadow-lg"
          >
            <FaCalendarAlt className="text-white text-3xl mb-4 mx-auto" />
            <h3 className="text-xl font-semibold mb-2">Book a Session</h3>
            <a
              href="https://bit.ly/BuildADreamWithNikki"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white text-sm underline hover:text-[#9AA7B2] transition"
            >
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex justify-center gap-8 text-3xl">
            <a
              ...
              className="text-white hover:text-[#9AA7B2] transition"
            >
              <FaInstagram />
            </a>
            <a
